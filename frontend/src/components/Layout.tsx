    ...
    <>
      ...
      <div className="flex h-16 items-center justify-between border-b border-gray-800 px-4">
        ...
        <button
          ...
          className="hidden lg:flex h-7 w-7 items-center justify-center rounded-lg text-gray-400 transition-colors hover:bg-white/10 hover:text-white"
        >
        ...
        <button
          ...
          className="flex lg:hidden h-7 w-7 items-center justify-center rounded-lg text-gray-400 transition-colors hover:bg-white/10 hover:text-white"
        >
